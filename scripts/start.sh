...
DB_TIMEZONE="${DB_TIMEZONE:-Africa/Johannesburg}"
API_PORT="${API_PORT:-8000}"
FRONTEND_PORT="${FRONTEND_PORT:-4200}"
LOAD_GCP_SECRETS="${LOAD_GCP_SECRETS:-false}"
AUDIT_SUCCESS_PAYLOADS_ENABLED="${AUDIT_SUCCESS_PAYLOADS_ENABLED:-false}"

export GOOGLE_CLOUD_PROJECT CLOUD_SQL_INSTANCE DB_HOST DB_PORT DB_TIMEZONE API_PORT FRONTEND_PORT LOAD_GCP_SECRETS AUDIT_SUCCESS_PAYLOADS_ENABLED
