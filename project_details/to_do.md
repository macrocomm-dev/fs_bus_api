...
- Deploy destination-display photo support to backend/dashboard before enabling mobile uploads; the new Cloud SQL table is already created. Verify a capture and readback after deployment.
